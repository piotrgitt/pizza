...
class PrzygotowanoCtrl {
    ...
    public function action_przygotowano() {   
        $this->getParams();
    ...
    public function getMyReservations() {  
        ...
        if($this->validate()){
            ...
            $this->zamowienia = App::getDB()->select("zamowienia", 
                [
                    ...
                    "zamowienia.przygotowane_do_dostawy" => 1,
     ...
     public function action_dostarczono_zamowienie() {   
    ...
    public function generateView()
    {
        ...
        App::getSmarty()->display("przygotowano.tpl");    
    }
}
