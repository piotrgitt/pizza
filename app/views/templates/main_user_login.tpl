					...
					<nav id="nav">
						<ul>
							...
							<li><a href="{$conf->action_root}contact">Kontakt</a></li>
                                                        <li><a href="{$conf->action_root}reservation">Złóż zamówienie</a></li>
                                                        <li><a href="{$conf->action_root}my_reservations">Koszyk</a></li>
                                                        <li><a href="{$conf->action_root}moje_zamowienia">Moje zamówienia</a></li>
                                                        <li><a onclick="return confirm('Jesteś pewny, że chcesz usunąć konto? ');" href="{$conf->action_root}usun_konto">#Usuń konto</a></li>
