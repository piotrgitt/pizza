                                           ...
                                           {foreach $zamowienia as $zamowienie}
                                                {strip}
                                                        <tr>
                                                            ...
                                                            <td><a href="{$conf->action_root}dostarczono_zamowienie/{$zamowienie["id_zamowienia"]}" class="button" value="{$zamowienie["id_zamowienia"]}" id="id_zamowienia" name="id_zamowienia" > DOSTARCZ </a></td>
